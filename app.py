...
mask_file = open('videos/Mask_detector.mp4',mode='r') #enter the filename with filepath
video_mask = mask_file.read()

bloodcell_file = open('videos/BloodCell_Detector.mp4',mode='r') #enter the filename with filepath
